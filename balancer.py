...
from custom_types import CustomClass


# TODO: translate all docs and comments in english
# TODO: implement proper logging and log levels
# TODO: not as_seq and flatten can be set to True simultaneously: for now the data format is to be handled by the user
...
class Balancer:
    ...
    def __save_class_augmented_data(self, custom_class: CustomClass, decoded_vectors: list) -> None:
        ...
        root_dir_path = os.path.join(self.path, '..')
        augmented_dataset_path = os.path.join(root_dir_path, 'augmented_dataset')
